  ...
  return (
    <form onSubmit={(e) => onSubmit(e)}>
      ...
      <div className="formcarry-block">
        ...
        <input type="text" value={name} onChange={(e) => setAmount(e.target.value)} id="amount" placeholder="How many people" />
      </div>

      <div className="formcarry-block">
        <label htmlFor="date">Date</label>
        <input type="date" value={name} onChange={(e) => setDate(e.target.value)} id="date" placeholder="When do you want the experience" />
      </div>
